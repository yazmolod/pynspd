...
- Ошибки доступа к прокси теперь тоже попадают под retry-политику

### Изменено

- Обновлены схемы: слой "Красные линии" стал полигональным

## 1.1.12 - 2026-02-28

### Изменено

- Обновлены схемы до актуальных

## 1.1.11 - 2026-01-21

### Исправлено

- Исправлены заголовки запроса, вызывающие блокировку
...
- Схемы слоев обновлены до актуальных

## 1.1.9 - 2025-12-19

### Изменено

- Удалены отсутствующие на сайте слои ("Земля для стройки ПКК", "Земля для туризма ПКК", "Объекты туристского интереса")

## 1.1.8 - 2025-12-01

### Исправлено

- Обновлена некорректная обработка запроса объектов в больших границах
